const placeOfIssued = [
	{ idProvince: '00', name: 'Cục cảnh sát' },
...
const placeOfIssuedSelectEl = document.getElementById('place_of_issued')

placeOfIssued.forEach(province => {
	...
	placeOfIssuedSelectEl.appendChild(option)
})
